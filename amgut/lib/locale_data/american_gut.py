...
'SURVEY_TEXT_4': 'We used to ask that participants keep a 7 day food diary, however, we found this in practice to be extremely tedious and have since revised the diet questions such that they do not depend on a food diary. That being said, if you are interested in tracking your diet, we found <a href="http://caloriecount.about.com/">CalorieCount</a> to be a useful website.',
...
'RESULTS_TEXT_2': 'Sequencing and data analysis can take a few months, please be patient! We will let you know as soon as your samples have been sequenced and analyzed.',
