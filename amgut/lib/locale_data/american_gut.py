...
_FAQ = {
    ...
    'INTRODUCTION_WHAT_IS_GUT_HEAD': "<h4>What is a Gut?</h4>",
    ...
    'INTRODUCTION_WHAT_IS_PROJECT_HEAD': "<h4>What is the %(project_name)s?</h4>" % {'project_name': AMGUT_CONFIG.project_name},
    ...
    'INTRODUCTION_WHAT_IS_16S_HEAD': "<h4>What is 16S rRNA?</h4>",
    ...
    'INTRODUCTION_ROBOTS_HEAD': "<h4>Do you really have a robot?</h4>",
    ...
    'INTRODUCTION_TREE_HEAD': "<h4>Tree of life</h4>",
    ...
    'INTRODUCTION_MICROBIOME_HEAD': "<h4>What is a microbiome?</h4>",
    ...
    'INTRODUCTION_EAT_HEAD': "<h4>What do my microbes eat?</h4>",
    ...
    'INTRODUCTION_MICROBES_COME_FROM_HEAD': "<h4>Where do my microbes come from?</h4>",
    ...
    'INTRODUCTION_DISCOVER_HEAD': "<h4>What will we discover in your gut?</h4>",
    ...
    'INTRODUCTION_STORIES_HEAD': "<h4>A few of the stories of the evolutionary tree in your gut</h4>",
