...
_CHANGE_PASS_VERIFY = {
    ...
    'NO_EMAIL_3': 'This is a courtesy email to confirm that you have changed your password for your kit with ID %(kitid)s If you did not request this change, please email us immediately at %(help_email)s.' % {"help_email": media_locale["HELP_EMAIL"]}
}
