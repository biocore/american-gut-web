...
_ADDENDUM = {
    ...
    'CHIMP_TAXONOMY': '',
    'CHIMP_TAXONOMY_KINGDOM': '',
    'CHIMP_TAXONOMY_PHYLUM': '',
    'CHIMP_TAXONOMY_CLASS': '',
    'CHIMP_TAXONOMY_ORDER': '',
    'CHIMP_TAXONOMY_FAMILY': '',
    'CHIMP_TAXONOMY_GENUS': '',
    'CHIMP_TAXONOMY_SPECIES': '',
    'LACTO_TAXONOMY': '',
    'LACTO_TAXONOMY_KINGDOM': '',
    'LACTO_TAXONOMY_PHYLUM': '',
    'LACTO_TAXONOMY_CLASS': '',
    'LACTO_TAXONOMY_ORDER': '',
    'LACTO_TAXONOMY_FAMILY': '',
    'LACTO_TAXONOMY_GENUS': '',
    'LACTO_TAXONOMY_SPECIES': '',
    'BACTAX_LINK': '',
    'TOP': '',
    'TAX_BARCHART': '',
    'TAX_BARCHART_TEXT_1': '',
    ...
    'COMPARE_TEXT_1': '',
    'COMPARE_TEXT_2': '',
    'DIFFERENT_BODY_SITES': '',
    'DIFFERENT_BODY_SITES_ALT': '',
    'DIFFERENT_BODY_SITES_TEXT': '',
    'DIFFERENT_AGES_POPS': '',
    'DIFFERENT_AGES_POPS_ALT': '',
    'DIFFERENT_AGES_POPS_TEXT': '',
    'AG_POPULATION': '',
    'AG_POPULATION_ALT': '',
    'AG_POPULATION_TEXT': '',
    'MAJOR_PHYLA': '',
    'MAJOR_PHYLA_FIRMICUTES_HEADER': '',
    'MAJOR_PHYLA_FIRMICUTES_TEXT': '',
    'MAJOR_PHYLA_BACTEROIDETES_HEADER': '',
    'MAJOR_PHYLA_BACTEROIDETES_TEXT': '',
    'MAJOR_PHYLA_PROTEOBACTERIA_HEADER': '',
    'MAJOR_PHYLA_PROTEOBACTERIA_TEXT': '',
    'MAJOR_PHYLA_ACTINOBACTERIA_HEADER': '',
    'MAJOR_PHYLA_ACTINOBACTERIA_TEXT': '',
    'MAJOR_PHYLA_VERRUCOMICROBIA_HEADER': '',
    'MAJOR_PHYLA_VERRUCOMICROBIA_TEXT': '',
    'MAJOR_PHYLA_TENERICUTES_HEADER': '',
    'MAJOR_PHYLA_TENERICUTES_TEXT': '',
    'MAJOR_PHYLA_CYANOBACTERIA_HEADER': '',
    'MAJOR_PHYLA_CYANOBACTERIA_TEXT': '',
    'MAJOR_PHYA_FUSOBACTERIA_HEADER': '',
    'MAJOR_PHYLA_FUSOBACTERIA_TEXT': '',
    'CONTRIB': '',
    'SUPPORTERS': '',
    'SPONSORS': '',
    'COLLABORATORS': ''
