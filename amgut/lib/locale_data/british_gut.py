...
_NEW_PARTICIPANT = {
    ...
    'TEXT_TITLE': 'Study Title: %(project_name)s' % {'project_name': AMGUT_CONFIG.project_name},
    ...
    'TEXT_WITHDRAWAL_DESCRIPTION_2': 'To withdraw from the study send email to the %(project_name)s (www.humanfoodproject.com/american-gut/) using the email address you used to contact us about the study and include your access code so that we can delete your records.' % {'project_name': AMGUT_CONFIG.project_name},
    ...
    'TEXT_CONFIDENTIALITY_LIST_6': 'The sponsor or agency supporting the study: Howard Hughes Medical Institute and the %(project_name)s.' % {'project_name': AMGUT_CONFIG.project_name},
...
_FAQ = {
    ...
    'PARTICIPATE_WITH_DIAGNOSIS_ANS': "Of course! The only exclusion criteria are: you must be more than 6 weeks old and cannot be a convicted felon. Please keep in mind that, for legal and ethical reasons, the %(project_name)s does not provide medically actionable results or advice." % {'project_name': AMGUT_CONFIG.project_name},
...
_ADDENDUM = {
    ...
    'AG_POPULATION': "The %(project_shorthand)s Population" % {'project_shorthand': AMGUT_CONFIG.project_shorthand},
    'AG_POPULATION_ALT': "PCoA of %(project_shorthand)s population colored by Firmicutes" % {'project_shorthand': AMGUT_CONFIG.project_shorthand},
    'AG_POPULATION_TEXT': "This plot lets you compare your sample to other faecal microbiome samples we collected from %(project_shorthand)s participants. The colour indicates the relative abundance of Firmicutes bacteria each sample had with red being the lowest and purple being the highest. If you had a lot of Firmicutes bacteria, then your sample should be purple, and you can look for other purple samples to see how similar your whole bacterial community is to other people with high amounts of Firmicutes. As in the other plots, the location of the point along the axes means nothing. Only its relative position compared to the other points is meaningful." % {'project_shorthand': AMGUT_CONFIG.project_shorthand},
    ...
    'DIFFERENT_BODY_SITES_TEXT': "This plot lets you compare your sample to samples collected in other microbiome projects from several body sites. The colour of each point tells you which project and body site the sample came from. HMP refers to the <a href = 'http://www.hmpdacc.org'>Human Microbiome Project</a>, funded by the National Institutes of Health. You can see how your sample compared to fecal, oral, and skin samples from the Human Microbiome Project, as well as to fecal, oral, and skin samples from the %(project_name)s, the Global Gut Project, and the Personal Genome Project. These samples have been combined in any category not labeled &quot;HMP&quot;. The oval around each group of points shows you where an average sample from each project and body site should fall on the plot. These sometimes make it easier to see the patterns all the clusters of points make." % {'project_name': AMGUT_CONFIG.project_name},
