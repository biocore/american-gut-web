...
_PORTAL = {
    ...
    'RESULTS_READY_TEXT_1': "One or more of the samples you submitted have been sequenced, and the results are now available online! We will be mailing hardcopies of these results shortly. Currently, we have only processed faecal samples, but we will be processing samples from other body sites soon.",
