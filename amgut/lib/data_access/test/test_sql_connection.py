...
from amgut.lib.data_access.sql_connection import (
    SQLConnectionHandler, Transaction, TRN)
...
class TestConnHandler(TestBase):
    def setUp(self):
        ...
        super(TestConnHandler, self).setUp()

    def tearDown(self):
        del self.conn_handler
        super(TestConnHandler, self).tearDown()
    ...
    def test_sql_executor_no_sql_args(self):
        sql = "INSERT INTO ag.test_table (int_column) VALUES (1)"
