...
ALTER TABLE barcodes.project_barcode ADD CONSTRAINT pk_project_barcode UNIQUE ( project_id );
...
CREATE TABLE barcodes.extraction_plate ( 
	...
	kf_robot             bigint  NOT NULL,
	ext_kit_lot          bigint  NOT NULL,
...
ALTER TABLE barcodes.pcr_plate ADD CONSTRAINT fk_pcr_plate_4 FOREIGN KEY (  ) REFERENCES barcodes.protocol(  );
...
ALTER TABLE barcodes.primer_plate ADD CONSTRAINT fk_sequencing_plate FOREIGN KEY (  ) REFERENCES barcodes.protocol(  );

CREATE TABLE barcodes.primer_plate_lot ( 
	primer_plate         varchar  NOT NULL,
	primer_plate_lot     varchar  NOT NULL,
	date_added           date DEFAULT current_date NOT NULL,
	CONSTRAINT pk_primer_plate_lot PRIMARY KEY ( primer_plate_lot, primer_plate )
 );
CREATE INDEX idx_primer_plate_lot ON barcodes.primer_plate_lot ( primer_plate );
ALTER TABLE barcodes.primer_plate_lot ADD CONSTRAINT fk_primer_plate_lot FOREIGN KEY ( primer_plate ) REFERENCES barcodes.primer_plate( primer_plate_id );
