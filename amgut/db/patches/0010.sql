CREATE TABLE ag.external_survey ( 
...
CREATE TABLE ag.external_survey_answers ( 
	...
	CONSTRAINT pk_third_party_surveys PRIMARY KEY ( survey_id )
 );
...
ALTER TABLE ag.external_survey_answers ADD CONSTRAINT fk_external_survey FOREIGN KEY ( external_survey_id ) REFERENCES ag.external_survey( external_survey_id );