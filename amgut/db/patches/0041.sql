...
INSERT INTO pm.shotgun_index (shotgun_index_id, bases)
    VALUES
        ('NEXTflex1', 'ATCTAGCCGGCC'),
        ('NEXTflex2', 'TATCTCTTCCTT'),
        ('NEXTflex3', 'TAGATGCCGTCC'),
        ('NEXTflex4', 'CGCTCCTTCCTT'),
        ('NEXTflex5', 'CGAGCGCCGTCC'),
        ('NEXTflex6', 'TCGAGAGTCCGG'),
        ('NEXTflex7', 'GCTCGGCCGGCC'),
        ('NEXTflex8', 'AGCTCAGTCCGG'),
        ('NEXTflex9', 'ACTGCCGCGTCC'),
        ('NEXTflex10', 'TTACTTCTCCGG'),
        ('NEXTflex11', 'TGACGCGCGGCC'),
        ('NEXTflex12', 'AATGATCTCCGG'),
        ('NEXTflex13', 'AAGCGTACGTCC'),
        ('NEXTflex14', 'TTATCAGTCCTT'),
        ('NEXTflex15', 'GTCATCGCGTCC'),
        ('NEXTflex16', 'CCGTCTCTCCGG'),
        ('NEXTflex17', 'TTCGCTACGTCC'),
        ('NEXTflex18', 'ACGCTCTTCCGG'),
        ('NEXTflex19', 'CAGTACGCGGCC'),
        ('NEXTflex20', 'GTACTGATCCTT'),
        ('NEXTflex21', 'GGATATACGGCC'),
        ('NEXTflex22', 'CATAGCTTCCGG'),
        ('NEXTflex23', 'GAGGCATCGGCC'),
        ('NEXTflex24', 'ATAAGGATCCGG'),
        ('NEXTflex25', 'CTCCGATCGTCC'),
        ('NEXTflex26', 'TATTCGATCCGG'),
        ('NEXTflex27', 'TCTTAATCGTCC'),
        ('NEXTflex28', 'CGCCTGATCCGG'),
        ('NEXTflex29', 'AGAATATCGTCC'),
        ('NEXTflex30', 'GCGGAGATCCGG'),
        ('NEXTflex31', 'CATGGCCGGTCC'),
        ('NEXTflex32', 'GTCACGTACCTT'),
        ('NEXTflex33', 'TGCAACCGGTCC'),
        ('NEXTflex34', 'CCTGTTGACCGG'),
        ('NEXTflex35', 'AGCCCAAGGTCC'),
        ('NEXTflex36', 'GCTTGGTACCGG'),
        ('NEXTflex37', 'TCGGGAAGGTCC'),
        ('NEXTflex38', 'CGAACGTACCGG'),
        ('NEXTflex39', 'GATTTAAGGGCC'),
        ('NEXTflex40', 'AGAACTGACCTT'),
        ('NEXTflex41', 'CCGCCTTGGTCC'),
        ('NEXTflex42', 'TGATGCAACCGG'),
        ('NEXTflex43', 'GGCGGTTGGGCC'),
        ('NEXTflex44', 'ACTACCAACCGG'),
        ('NEXTflex45', 'AATAATTGGTCC'),
        ('NEXTflex46', 'GTCGTCAACCGG'),
        ('NEXTflex47', 'AAATCTCAGGCC'),
        ('NEXTflex48', 'GTGCGCGGCCGG'),
        ('NEXTflex49', 'TTTAGTCAGTCC'),
        ('NEXTflex50', 'CACGCCGGCCGG'),
        ('NEXTflex51', 'CCCGATCAGTCC'),
        ('NEXTflex52', 'TGTATCGGCCGG'),
        ('NEXTflex53', 'CTTTCAGAGTCC'),
        ('NEXTflex54', 'TACCGGCGCCGG'),
        ('NEXTflex55', 'GAAAGAGAGTCC'),
        ('NEXTflex56', 'CTGGCTAGCCTT'),
        ('NEXTflex57', 'AGGGAAGAGGCC'),
        ('NEXTflex58', 'GACCGTAGCCTT'),
        ('NEXTflex59', 'TCCCTAGAGTCC'),
        ('NEXTflex60', 'AGTTATAGCCTT'),
        ('NEXTflex61', 'GCCTCGAAGTCC'),
        ('NEXTflex62', 'CGTCGCGGCCTT'),
        ('NEXTflex63', 'CGGAGGAAGGCC'),
        ('NEXTflex64', 'GCAGCCGGCCTT'),
        ('NEXTflex65', 'TAAGAGAAGTCC'),
        ('NEXTflex66', 'ATGATCGGCCTT'),
        ('NEXTflex67', 'ATTCTGAAGTCC'),
        ('NEXTflex68', 'TACTACGGCCTT'),
        ('NEXTflex69', 'TGGTCCTAGTCC'),
        ('NEXTflex70', 'AACATTAGCCGG'),
        ('NEXTflex71', 'ACCAGCTAGTCC'),
        ('NEXTflex72', 'TTGTATAGCCGG'),
        ('NEXTflex73', 'GTTGACTAGTCC'),
        ('NEXTflex74', 'CCACGTAGCCGG'),
        ('NEXTflex75', 'CAACTCTAGTCC'),
        ('NEXTflex76', 'TGTGCGCGCCTT'),
        ('NEXTflex77', 'GGTACTGTGGCC'),
        ('NEXTflex78', 'AAATTAACCCTT'),
        ('NEXTflex79', 'TTGCATGTGGCC'),
        ('NEXTflex80', 'CCCGGAACCCTT'),
        ('NEXTflex81', 'AACGTTGTGTCC'),
        ('NEXTflex82', 'GGGCCAACCCTT'),
        ('NEXTflex83', 'CACACCATGTCC'),
        ('NEXTflex84', 'TTTGGTTCCCGG'),
        ('NEXTflex85', 'GTGTGCATGTCC'),
        ('NEXTflex86', 'CCCAATTCCCGG'),
        ('NEXTflex87', 'TGTGTCATGTCC'),
        ('NEXTflex88', 'AAACCTTCCCGG'),
        ('NEXTflex89', 'ATGACGTTGTCC'),
        ('NEXTflex90', 'TCCTTAACCCGG'),
        ('NEXTflex91', 'CGTCAGTTGTCC'),
        ('NEXTflex92', 'GAAGGAACCCGG'),
        ('NEXTflex93', 'GCAGTGTTGGCC'),
        ('NEXTflex94', 'CTTCCAACCCGG'),
        ('NEXTflex95', 'GTATGACCAGCC'),
        ('NEXTflex96', 'CCTAAGGTTCGG'),
        ('NEXTflex97', 'TGCGTACCATCC'),
        ('NEXTflex98', 'AAGCCGGTTCGG'),
        ('NEXTflex99', 'ATAACTGCATCC'),
        ('NEXTflex100', 'GAGGGCCTTCGG'),
        ('NEXTflex101', 'TATTGTGCAGCC'),
        ('NEXTflex102', 'AGAAACCTTCGG'),
        ('NEXTflex103', 'CGCCATGCATCC'),
        ('NEXTflex104', 'TCTTTCCTTCGG'),
        ('NEXTflex105', 'GCGGTTGCATCC'),
        ('NEXTflex106', 'ATCCCAATTCTT'),
        ('NEXTflex107', 'TCGACCACAGCC'),
        ('NEXTflex108', 'CTCTTGGTTCTT'),
        ('NEXTflex109', 'AGCTGCACAGCC'),
        ('NEXTflex110', 'TCTCCGGTTCTT'),
        ('NEXTflex111', 'CTAGTCACAGCC'),
        ('NEXTflex112', 'GAGAAGGTTCTT'),
        ('NEXTflex113', 'CCGTGGTCATCC'),
        ('NEXTflex114', 'TGACCAATTCGG'),
        ('NEXTflex115', 'TTACAGTCATCC'),
        ('NEXTflex116', 'CAGTTAATTCGG'),
        ('NEXTflex117', 'AATGTGTCAGCC'),
        ('NEXTflex118', 'TTCAACCTTCTT'),
        ('NEXTflex119', 'GCTTCTCGATCC'),
        ('NEXTflex120', 'ATAATATATCTT'),
        ('NEXTflex121', 'CGAAGTCGATCC'),
        ('NEXTflex122', 'TCGGCCGATCGG'),
        ('NEXTflex123', 'TAGGATCGATCC'),
        ('NEXTflex124', 'CTAATCGATCGG'),
        ('NEXTflex125', 'ATCCTTCGATCC'),
        ('NEXTflex126', 'GATTACGATCGG'),
        ('NEXTflex127', 'TGATCAGGAGCC'),
        ('NEXTflex128', 'CCGCGGCATCGG'),
        ('NEXTflex129', 'ACTAGAGGATCC'),
        ('NEXTflex130', 'GTATATAATCTT'),
        ('NEXTflex131', 'GTCGAAGGAGCC'),
        ('NEXTflex132', 'AATATGCATCGG'),
        ('NEXTflex133', 'CAGCTAGGATCC'),
        ('NEXTflex134', 'TGCGCTAATCTT'),
        ('NEXTflex135', 'TTCAGGAGAGCC'),
        ('NEXTflex136', 'ACGTAATATCGG'),
        ('NEXTflex137', 'CCTGAGAGATCC'),
        ('NEXTflex138', 'TTACGCGATCTT'),
        ('NEXTflex139', 'GGACTGAGATCC'),
        ('NEXTflex140', 'CATGCATATCGG'),
        ('NEXTflex141', 'CTCTCCTGATCC'),
        ('NEXTflex142', 'GATCGGCATCTT'),
        ('NEXTflex143', 'GAGAGCTGAGCC'),
        ('NEXTflex144', 'ATAGCTAATCGG'),
        ('NEXTflex145', 'AGAGACTGATCC'),
        ('NEXTflex146', 'TCGATGCATCTT'),
        ('NEXTflex147', 'TCTCTCTGAGCC'),
        ('NEXTflex148', 'CGCTATAATCGG'),
        ('NEXTflex149', 'TCAGGCCAAGCC'),
        ('NEXTflex150', 'CGGACTGGTCGG'),
        ('NEXTflex151', 'CTGAACCAATCC'),
        ('NEXTflex152', 'GCCTGTGGTCGG'),
        ('NEXTflex153', 'GACTTCCAAGCC'),
        ('NEXTflex154', 'CTTCAGTGTCTT'),
        ('NEXTflex155', 'CCACCGGAATCC'),
        ('NEXTflex156', 'TGGTGACGTCGG'),
        ('NEXTflex157', 'AACAAGGAAGCC'),
        ('NEXTflex158', 'GTTGTACGTCGG'),
        ('NEXTflex159', 'TTGTTGGAATCC'),
        ('NEXTflex160', 'AAACACAGTCTT'),
        ('NEXTflex161', 'ATGGGTTAATCC'),
        ('NEXTflex162', 'GAAACCAGTCGG'),
        ('NEXTflex163', 'GCAAATTAACCC'),
        ('NEXTflex164', 'CTTTGCAGTGGG'),
        ('NEXTflex165', 'TTTGCGCTATCC'),
        ('NEXTflex166', 'CCACTCTCTCTT'),
        ('NEXTflex167', 'AAACGGCTATCC'),
        ('NEXTflex168', 'TGTGAAGCTCGG'),
        ('NEXTflex169', 'GGGTAGCTATCC'),
        ('NEXTflex170', 'AACAGCTCTCTT'),
        ('NEXTflex171', 'CCCATGCTAGCC'),
        ('NEXTflex172', 'TTGTCCTCTCTT'),
        ('NEXTflex173', 'GAAGCCGTATCC'),
        ('NEXTflex174', 'CTGAGGACTCTT'),
        ('NEXTflex175', 'CTTCGCGTAGCC'),
        ('NEXTflex176', 'GACTCGACTCTT'),
        ('NEXTflex177', 'TCCTACGTATCC'),
        ('NEXTflex178', 'AGTCTGACTCTT'),
        ('NEXTflex179', 'ATGGCGCGCTGG'),
        ('NEXTflex180', 'GCCCTCTAGCAA'),
        ('NEXTflex181', 'CGTTAGCGCGGG'),
        ('NEXTflex182', 'TAAAGCTAGCAA'),
        ('NEXTflex183', 'GCAATGCGCTGG'),
        ('NEXTflex184', 'ATTTCCTAGCAA'),
        ('NEXTflex185', 'GGTGCTAGCTGG'),
        ('NEXTflex186', 'CCCAGAGAGCAA'),
        ('NEXTflex187', 'TCAGCATGCTGG'),
        ('NEXTflex188', 'AGGAGTCAGCAA'),
        ('NEXTflex189', 'AGTCGATGCTGG'),
        ('NEXTflex190', 'GAAGATCAGCAA'),
        ('NEXTflex191', 'GACTAATGCTGG'),
        ('NEXTflex192', 'CTTCTTCAGCAA'),
        ('NEXTflex193', 'CTGATATGCTGG'),
        ('NEXTflex194', 'TCCTCTCAGCAA'),
        ('NEXTflex195', 'GAGACACACGGG'),
        ('NEXTflex196', 'CTAGGTTGGCAA'),
        ('NEXTflex197', 'CTCTGACACTGG'),
        ('NEXTflex198', 'TCGAATTGGCAA'),
        ('NEXTflex199', 'AGAGTACACTGG'),
        ('NEXTflex200', 'GATCCTTGGCAA'),
        ('NEXTflex201', 'TTCACTGACGGG'),
        ('NEXTflex202', 'CCGTTAAGGCAA'),
        ('NEXTflex203', 'AAGTGTGACTGG'),
        ('NEXTflex204', 'TTACCAAGGCAA'),
        ('NEXTflex205', 'ATCCAGTACGGG'),
        ('NEXTflex206', 'TATTTCCGGCAA'),
        ('NEXTflex207', 'TAGGTGTACCGG'),
        ('NEXTflex208', 'ATAAACCGGTAA'),
        ('NEXTflex209', 'CTAGAAGTCCGG'),
        ('NEXTflex210', 'GAGATTACGTAA'),
        ('NEXTflex211', 'GATCTAGTCCGG'),
        ('NEXTflex212', 'AGAGCTACGGAA'),
        ('NEXTflex213', 'TTGACCATGTGG'),
        ('NEXTflex214', 'CCCTTGGCCCAA'),
        ('NEXTflex215', 'GCATGACTGTGG'),
        ('NEXTflex216', 'ATTAATTCCCAA'),
        ('NEXTflex217', 'CGTACACTGTGG'),
        ('NEXTflex218', 'GCCGGTTCCCAA'),
        ('NEXTflex219', 'TTTCTCTAGTGG'),
        ('NEXTflex220', 'CCAGCGCGCCAA'),
        ('NEXTflex221', 'AAAGACTAGTGG'),
        ('NEXTflex222', 'TTGATGCGCCAA'),
        ('NEXTflex223', 'GAACTGAAGTGG'),
        ('NEXTflex224', 'AGTGCCGGCCAA'),
        ('NEXTflex225', 'CTTGAGAAGTGG'),
        ('NEXTflex226', 'TCACGCGGCCAA'),
        ('NEXTflex227', 'TCCAGGAAGTGG'),
        ('NEXTflex228', 'CTGTACGGCCAA'),
        ('NEXTflex229', 'AGGTCGAAGTGG'),
        ('NEXTflex230', 'GACATCGGCCAA'),
        ('NEXTflex231', 'CGGCTAGAGTGG'),
        ('NEXTflex232', 'TACGCTAGCCAA'),
        ('NEXTflex233', 'GCCGAAGAGTGG'),
        ('NEXTflex234', 'CGTATTAGCCAA'),
        ('NEXTflex235', 'ATTAGAGAGTGG'),
        ('NEXTflex236', 'GCATATAGCCAA'),
        ('NEXTflex237', 'TAATCAGAGTGG'),
        ('NEXTflex238', 'ATGCGTAGCCAA'),
        ('NEXTflex239', 'ACCCTTCAGTGG'),
        ('NEXTflex240', 'GTGGCATGCCAA'),
        ('NEXTflex241', 'TGGGATCAGTGG'),
        ('NEXTflex242', 'CACCGATGCCAA'),
        ('NEXTflex243', 'CAAAGTCAGTGG'),
        ('NEXTflex244', 'TGTTAATGCCAA'),
        ('NEXTflex245', 'GTTTCTCAGTGG'),
        ('NEXTflex246', 'ACAATATGCCAA'),
        ('NEXTflex247', 'GTAAATTGGTGG'),
        ('NEXTflex248', 'ACTTGACACCAA'),
        ('NEXTflex249', 'ACGGGTTGGTGG'),
        ('NEXTflex250', 'TGAACACACCAA'),
        ('NEXTflex251', 'TGCCCTTGGTGG'),
        ('NEXTflex252', 'CAGGTACACCAA'),
        ('NEXTflex253', 'ATATTAAGGTGG'),
        ('NEXTflex254', 'GCTACTGACCAA'),
        ('NEXTflex255', 'CGCGGAAGGTGG'),
        ('NEXTflex256', 'TAGCATGACCAA'),
        ('NEXTflex257', 'GCGCCAAGGTGG'),
        ('NEXTflex258', 'CGATGTGACCAA'),
        ('NEXTflex259', 'GGCTTCCGGTGG'),
        ('NEXTflex260', 'CCTCAGTACCAA'),
        ('NEXTflex261', 'TTAGGCCGGTGG'),
        ('NEXTflex262', 'AAGACGTACCAA'),
        ('NEXTflex263', 'GCTATATCGTGG'),
        ('NEXTflex264', 'ATATCTCTCCAA'),
        ('NEXTflex265', 'CGATAATCGTGG'),
        ('NEXTflex266', 'TATAGTCTCCAA'),
        ('NEXTflex267', 'TAGCGATCGTGG'),
        ('NEXTflex268', 'CGCGATCTCCAA'),
        ('NEXTflex269', 'ATCGCATCGTGG'),
        ('NEXTflex270', 'GCGCTTCTCCAA'),
        ('NEXTflex271', 'TGAATTACGCGG'),
        ('NEXTflex272', 'CATTCAGTCTAA'),
        ('NEXTflex273', 'GGAAGAGGACGG'),
        ('NEXTflex274', 'ACGGCGCATTCC'),
        ('NEXTflex275', 'CCTTCAGGAGGG'),
        ('NEXTflex276', 'GTAATGCATCCC'),
        ('NEXTflex277', 'GAGCTTCGACGG'),
        ('NEXTflex278', 'CTATAATATTAA'),
        ('NEXTflex279', 'CTCGATCGACGG'),
        ('NEXTflex280', 'TATATCGATGCC'),
        ('NEXTflex281', 'TCTAGTCGATGG'),
        ('NEXTflex282', 'CGCGCCGATCCC'),
        ('NEXTflex283', 'AGATCTCGACGG'),
        ('NEXTflex284', 'GCGCGCGATGCC'),
        ('NEXTflex285', 'GTAGTGTCATGG'),
        ('NEXTflex286', 'CCTCCAATTCCC'),
        ('NEXTflex287', 'CATCAGTCAGGG'),
        ('NEXTflex288', 'GTCTTCCTTCAA'),
        ('NEXTflex289', 'ACGACGTCACGG'),
        ('NEXTflex290', 'TTCTTAATTGCC'),
        ('NEXTflex291', 'TATGTCACATGG'),
        ('NEXTflex292', 'ATCAAGGTTCAA'),
        ('NEXTflex293', 'ATACACACATGG'),
        ('NEXTflex294', 'TAGTTGGTTCAA'),
        ('NEXTflex295', 'AGCGTTGCACGG'),
        ('NEXTflex296', 'GAGCCAATTGAA'),
        ('NEXTflex297', 'TCGCATGCATGG'),
        ('NEXTflex298', 'CTCGGAATTCAA'),
        ('NEXTflex299', 'CTATGTGCACGG'),
        ('NEXTflex300', 'GCTAACCTTTCC'),
        ('NEXTflex301', 'GATACTGCACGG'),
        ('NEXTflex302', 'ATCGGCCTTTCC'),
        ('NEXTflex303', 'CCGGTACCATGG'),
        ('NEXTflex304', 'GTCCCGGTTCCC'),
        ('NEXTflex305', 'AATTGACCACGG'),
        ('NEXTflex306', 'TGAAAGGTTTCC'),
        ('NEXTflex307', 'CCAGTCATGCGG'),
        ('NEXTflex308', 'TTTCCGGCCGAA'),
        ('NEXTflex309', 'CGGCCTTCCCAA'),
        ('NEXTflex310', 'GACGTCATGTTT'),
        ('NEXTflex311', 'ACACACATGTCC'),
        ('NEXTflex312', 'TGGTTGGCCCTT'),
        ('NEXTflex313', 'GCTAATCTGGAA'),
        ('NEXTflex314', 'CTATGCGCCATT'),
        ('NEXTflex315', 'CGATTTCTGAAA'),
        ('NEXTflex316', 'GCGCAATCCGGG'),
        ('NEXTflex317', 'CAGGGAGTGGAA'),
        ('NEXTflex318', 'TGCCATACCAGG'),
        ('NEXTflex319', 'AAGAAGATGGAA'),
        ('NEXTflex320', 'GTAGTATCCATT'),
        ('NEXTflex321', 'TTCTTGATGAAA'),
        ('NEXTflex322', 'ACGACATCCGTT'),
        ('NEXTflex323', 'AGACCCTTGAAA'),
        ('NEXTflex324', 'TATGTTACCGTT'),
        ('NEXTflex325', 'TCTGGCTTGAAA'),
        ('NEXTflex326', 'CGCACTACCGTT'),
        ('NEXTflex327', 'GAGTTCTTGGAA'),
        ('NEXTflex328', 'ATACATACCATT'),
        ('NEXTflex329', 'AGGCCAGCAGAA'),
        ('NEXTflex330', 'TACGTGCTTATT'),
        ('NEXTflex331', 'TCCGGAGCAGAA'),
        ('NEXTflex332', 'ATGCAGCTTATT'),
        ('NEXTflex333', 'GAATTAGCAGAA'),
        ('NEXTflex334', 'CGTACGCTTATT'),
        ('NEXTflex335', 'TAACCGACATAA'),
        ('NEXTflex336', 'AGTGTATTTATT'),
        ('NEXTflex337', 'ATTGGGACAGAA'),
        ('NEXTflex338', 'TCACAATTTATT'),
        ('NEXTflex339', 'GCCAAGACAGAA'),
        ('NEXTflex340', 'CTGTGATTTATT'),
        ('NEXTflex341', 'ATTGCGGTGAAA'),
        ('NEXTflex342', 'GACAGACCCTTT'),
        ('NEXTflex343', 'GATATCTAATTT'),
        ('NEXTflex344', 'ATCGATAGTAAA'),
        ('NEXTflex345', 'TGAGGACTAATT'),
        ('NEXTflex346', 'AATCAGGCTTAA'),
        ('NEXTflex347', 'CAGAAACTATTT'),
        ('NEXTflex348', 'TGCTGTTCTACC'),
        ('NEXTflex349', 'GTCTTACTATTT'),
        ('NEXTflex350', 'CATCATTCTACC'),
        ('NEXTflex351', 'CGACCTGTATTT'),
        ('NEXTflex352', 'GCGTGAACTCCC'),
        ('NEXTflex353', 'GCTGGTGTATTT'),
        ('NEXTflex354', 'CTACACCCTAAA'),
        ('NEXTflex355', 'ATCAATGTATTT'),
        ('NEXTflex356', 'TATGTAACTACC'),
        ('NEXTflex357', 'TAGTTTGTATTT'),
        ('NEXTflex358', 'ATACAAACTCCC'),
        ('NEXTflex359', 'GAGCCCATAATT'),
        ('NEXTflex360', 'CGCGTTTCTTAA'),
        ('NEXTflex361', 'CCTATTACGTCC'),
        ('NEXTflex362', 'GGCGAAGTCCTT'),
        ('NEXTflex363', 'ACGTTCCGGTCC'),
        ('NEXTflex364', 'GGACATGACCGG'),
        ('NEXTflex365', 'GGGCTTCAGGCC'),
        ('NEXTflex366', 'ACATACGGCCGG'),
        ('NEXTflex367', 'CATACACCATCC'),
        ('NEXTflex368', 'GGATTGGTTCGG'),
        ('NEXTflex369', 'GGCACGTCAGCC'),
        ('NEXTflex370', 'ACTGGAATTCGG'),
        ('NEXTflex371', 'AAGTCGAGAGCC'),
        ('NEXTflex372', 'GGCATCGATCTT'),
        ('NEXTflex373', 'GGCAGTCTCTGG'),
        ('NEXTflex374', 'CCTGCATCGCAA'),
        ('NEXTflex375', 'GGGAGCTAGTGG'),
        ('NEXTflex376', 'AACTAGCGCCAA'),
        ('NEXTflex377', 'CCCTCCTAGTGG'),
        ('NEXTflex378', 'GGTCGGCGCCAA'),
        ('NEXTflex379', 'CCGAACCGGTGG'),
        ('NEXTflex380', 'GGAGTGTACCAA'),
        ('NEXTflex381', 'GGCCAACCACGG'),
        ('NEXTflex382', 'ACTTTGGTTGCC'),
        ('NEXTflex383', 'AACTGCATGCGG'),
        ('NEXTflex384', 'GGGAAGGCCTAA'),
        ('iTru5_01_A', 'TTGTCGGT'),
        ('iTru5_01_B', 'TTGCCACT'),
        ('iTru5_01_C', 'AGTCTGTG'),
        ('iTru5_01_D', 'AAGTGTCG'),
        ...
        ('iTru5_24_G', 'GGAAGGAT'),
        ('iTru5_24_H', 'CGTGTGTA'),
        ('iTru7_Primer', 'iTru7_Tag'),
        ('iTru7_101_01', 'ACGTTACC'),
        ('iTru7_101_02', 'CTGTGTTG'),
        ('iTru7_101_03', 'TGAGGTGT'),
        ('iTru7_101_04', 'GATCCATG'),
        ('iTru7_101_05', 'GCCTATCA'),
        ('iTru7_101_06', 'AACAACCG'),
        ('iTru7_101_07', 'ACTCGTTG'),
        ('iTru7_101_08', 'CCTATGGT'),
        ('iTru7_101_09', 'TGTACACC'),
        ('iTru7_101_10', 'GTATGCTG'),
        ('iTru7_101_11', 'TGATGTCC'),
        ('iTru7_101_12', 'GTCCTTCT'),
        ('iTru7_102_01', 'ATAAGGCG'),
        ('iTru7_102_02', 'CTTACCTG'),
        ('iTru7_102_03', 'CGTTGCAA'),
        ('iTru7_102_04', 'GATTCAGC'),
        ('iTru7_102_05', 'TCACGTTC'),
        ('iTru7_102_06', 'TGTGCGTT'),
        ('iTru7_102_07', 'TAGTTGCG'),
        ('iTru7_102_08', 'AAGAGCCA'),
        ('iTru7_102_09', 'ACAGCTCA'),
        ('iTru7_102_10', 'GTTAAGGC'),
        ('iTru7_102_11', 'AAGCCACA'),
        ('iTru7_102_12', 'ACACGGTT'),
        ('iTru7_103_01', 'CAGCGATT'),
        ('iTru7_103_02', 'TAGTGACC'),
        ('iTru7_103_03', 'CGAGACTA'),
        ('iTru7_103_04', 'GACATGGT'),
        ('iTru7_103_05', 'GCATGTCT'),
        ('iTru7_103_06', 'ACTCCATC'),
        ('iTru7_103_07', 'TGTGACTG'),
        ('iTru7_103_08', 'CGAAGAAC'),
        ('iTru7_103_09', 'GGTGTCTT'),
        ('iTru7_103_10', 'AAGAAGGC'),
        ('iTru7_103_11', 'AGGTTCGA'),
        ('iTru7_103_12', 'CATGTTCC'),
        ('iTru7_104_01', 'GTGCCATA'),
        ('iTru7_104_02', 'CCTTGTAG'),
        ('iTru7_104_03', 'GCTGGATT'),
        ('iTru7_104_04', 'TAACGAGG'),
        ('iTru7_104_05', 'ATGGTTGC'),
        ('iTru7_104_06', 'CCTATACC'),
        ('iTru7_104_07', 'TTAGGTCG'),
        ('iTru7_104_08', 'GCAAGATC'),
        ('iTru7_104_09', 'AGAGCCTT'),
        ('iTru7_104_10', 'GCAATGGA'),
        ('iTru7_104_11', 'CTGGAGTA'),
        ('iTru7_104_12', 'GAACATCG'),
        ('iTru7_105_01', 'GCACAACT'),
        ('iTru7_105_02', 'TTCTCTCG'),
        ('iTru7_105_03', 'AACGGTCA'),
        ('iTru7_105_04', 'ACAGACCT'),
        ('iTru7_105_05', 'TCTCTTCC'),
        ('iTru7_105_06', 'AGTGTTGG'),
        ('iTru7_105_07', 'TGGCATGT'),
        ('iTru7_105_08', 'AGAAGCGT'),
        ('iTru7_105_09', 'AGCGGAAT'),
        ('iTru7_105_10', 'TAACCGGT'),
        ('iTru7_105_11', 'CATGGAAC'),
        ('iTru7_105_12', 'ATGGTCCA'),
        ('iTru7_106_01', 'CTTCTGAG'),
        ('iTru7_106_02', 'AACCGAAG'),
        ('iTru7_106_03', 'TTCGTACC'),
        ('iTru7_106_04', 'CTGTTAGG'),
        ('iTru7_106_05', 'CACAAGTC'),
        ('iTru7_106_06', 'TCTTGACG'),
        ('iTru7_106_07', 'CGTCTTGT'),
        ('iTru7_106_08', 'CGTGATCA'),
        ('iTru7_106_09', 'CCAAGTTG'),
        ('iTru7_106_10', 'GTACCTTG'),
        ('iTru7_106_11', 'GACTATGC'),
        ('iTru7_106_12', 'TGGATCAC'),
        ('iTru7_107_01', 'CTCTGGTT'),
        ('iTru7_107_02', 'GTTCATGG'),
        ('iTru7_107_03', 'GCTGTAAG'),
        ('iTru7_107_04', 'GTCGAAGA'),
        ('iTru7_107_05', 'GAGCTCAA'),
        ('iTru7_107_06', 'TGAACCTG'),
        ('iTru7_107_07', 'CCGACTAT'),
        ('iTru7_107_08', 'AGCTAACC'),
        ('iTru7_107_09', 'GCCTTGTT'),
        ('iTru7_107_10', 'AACTTGCC'),
        ('iTru7_107_11', 'CAATGTGG'),
        ('iTru7_107_12', 'AAGGCTGA'),
        ('iTru7_108_01', 'TTACCGAG'),
        ('iTru7_108_02', 'GTCCTAAG'),
        ('iTru7_108_03', 'GAAGGTTC'),
        ('iTru7_108_04', 'GAAGAGGT'),
        ('iTru7_108_05', 'TCTGAGAG'),
        ('iTru7_108_06', 'ACCGCATA'),
        ('iTru7_108_07', 'GAAGTACC'),
        ('iTru7_108_08', 'CAGGTATC'),
        ('iTru7_108_09', 'TCTCTAGG'),
        ('iTru7_108_10', 'AAGCACTG'),
        ('iTru7_108_11', 'CCAAGCAA'),
        ('iTru7_108_12', 'TGTTCGAG'),
        ('iTru7_109_01', 'CTCGTCTT'),
        ('iTru7_109_02', 'CGAACTGT'),
        ('iTru7_109_03', 'CATTCGGT'),
        ('iTru7_109_04', 'TCGGTTAC'),
        ('iTru7_109_05', 'AAGTCGAG'),
        ('iTru7_109_06', 'TATCGGTC'),
        ('iTru7_109_07', 'TATTCGCC'),
        ('iTru7_109_08', 'GTATTGGC'),
        ('iTru7_109_09', 'AGTCGCTT'),
        ('iTru7_109_10', 'TGGCACTA'),
        ('iTru7_109_11', 'GGTTGTCA'),
        ('iTru7_109_12', 'AACCTCCT'),
        ('iTru7_110_01', 'ATGACCAG'),
        ('iTru7_110_02', 'AACCGTTC'),
        ('iTru7_110_03', 'TCCAATCG'),
        ('iTru7_110_04', 'CTGCACTT'),
        ('iTru7_110_05', 'CGCTTAAC'),
        ('iTru7_110_06', 'CACCACTA'),
        ('iTru7_110_07', 'ACAGCAAC'),
        ('iTru7_110_08', 'GGAAGGAT'),
        ('iTru7_110_09', 'GGCGTTAT'),
        ('iTru7_110_10', 'CTGTTGAC'),
        ('iTru7_110_11', 'GTCATCGA'),
        ('iTru7_110_12', 'TGACTTCG'),
        ('iTru7_111_01', 'CGATAGAG'),
        ('iTru7_111_02', 'TTCGTTGG'),
        ('iTru7_111_03', 'TGGAGAGT'),
        ('iTru7_111_04', 'TCAGACGA'),
        ('iTru7_111_05', 'GACGAATG'),
        ('iTru7_111_06', 'CATGAGGA'),
        ('iTru7_111_07', 'CGGTTGTT'),
        ('iTru7_111_08', 'TCCGTATG'),
        ('iTru7_111_09', 'TGTGGTAC'),
        ('iTru7_111_10', 'AGAACGAG'),
        ('iTru7_111_11', 'CTTCGTTC'),
        ('iTru7_111_12', 'CCAATAGG'),
        ('iTru7_112_01', 'ACCATCCA'),
        ('iTru7_112_02', 'CACACATG'),
        ('iTru7_112_03', 'CTTGTCGA'),
        ('iTru7_112_04', 'AGTCTCAC'),
        ('iTru7_112_05', 'AGTTGGCT'),
        ('iTru7_112_06', 'CCGGAATT'),
        ('iTru7_112_07', 'CAGTGAAG'),
        ('iTru7_112_08', 'CCTACTGA'),
        ('iTru7_112_09', 'TGTGAAGC'),
        ('iTru7_112_10', 'GTCTGATC'),
        ('iTru7_112_11', 'TTCAGGAG'),
        ('iTru7_112_12', 'ACGATGAC'),
        ('iTru7_113_01', 'CGTTATGC'),
        ('iTru7_113_02', 'GATACTGG'),
        ('iTru7_113_03', 'CTACTTGG'),
        ('iTru7_113_04', 'CATACCAC'),
        ('iTru7_113_05', 'ACATTGCG'),
        ('iTru7_113_06', 'TGATCGGA'),
        ('iTru7_113_07', 'AAGTGTCG'),
        ('iTru7_113_08', 'GAACGCTT'),
        ('iTru7_113_09', 'TCAAGGAC'),
        ('iTru7_113_10', 'TCAACTGG'),
        ('iTru7_113_11', 'GGTTGATG'),
        ('iTru7_113_12', 'AAGGACAC'),
        ('iTru7_114_01', 'TTGATCCG'),
        ('iTru7_114_02', 'GGTGATTC'),
        ('iTru7_114_03', 'GATTGCTC'),
        ('iTru7_114_04', 'ACCTGGAA'),
        ('iTru7_114_05', 'CATCTACG'),
        ('iTru7_114_06', 'CCGTATCT'),
        ('iTru7_114_07', 'CGGAATAC'),
        ('iTru7_114_08', 'CTCCTAGA'),
        ('iTru7_114_09', 'TGGTAGCT'),
        ('iTru7_114_10', 'TCGAAGGT'),
        ('iTru7_114_11', 'ACATAGGC'),
        ('iTru7_114_12', 'CTCAGAGT');
