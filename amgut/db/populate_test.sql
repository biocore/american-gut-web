...
insert into ag_login (ag_login_id, email, name, address, city, state, zip, country, latitude, longitude) 
    values('d8592c74-7da1-2135-e040-8a80115d6401', 'test@microbio.me', 'Test', 'Test', 'Boulder', 'CO', '80303', 'United States', '40.0005378', '-105.2077798');
insert into ag_kit (ag_kit_id, ag_login_id, supplied_kit_id, swabs_per_kit, kit_password, kit_verified, kit_verification_code) 
    values ('d8592c74-7da2-2135-e040-8a80115d6401','d8592c74-7da1-2135-e040-8a80115d6401','test', '1','%^&*test','y', 'test');
insert into ag_kit (ag_kit_id, ag_login_id, supplied_kit_id, swabs_per_kit, kit_password, kit_verified)
     values ('dbd466b5-651b-bfb2-e040-8a80115d6775','d8592c74-7da1-2135-e040-8a80115d6401','1111', '5', '1111','y');
