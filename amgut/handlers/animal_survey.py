...
class AnimalSurveyHandler(BaseHandler):
    ...
    def get(self):
        ...
        message = "The animal survey is currently under construction, please check back in a few days. We apologize for any inconvenience."
        self.render('animal_survey.html', message=message, skid=skid)
